  ...
  return (
    <div className="min-h-screen bg-slate-100 px-4 py-10">
      <div className="mx-auto max-w-3xl rounded-xl bg-white p-8 shadow">
        ...
        <h1 className="mt-4 text-2xl font-bold text-primary">Politique de confidentialité</h1>
        ...
        <section className="mt-6 space-y-3 text-sm leading-relaxed text-slate-700">
          <h2 className="text-lg font-semibold text-primary">1. Données collectées</h2>
          ...
          <h2 className="text-lg font-semibold text-primary">2. Finalités du traitement</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-primary">3. Sous-traitants et services tiers</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-primary">4. Durée de conservation</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-primary">5. Sécurité des données</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-primary">6. Droits des utilisateurs</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-primary">7. Cookies et traceurs</h2>
          <p>
