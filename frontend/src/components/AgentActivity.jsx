...
export default function AgentActivity({ events = [], agents = [], limit = 200 }) {
  ...
  return (
    <div className="max-h-96 space-y-1 overflow-y-auto rounded border border-outline-variant/30 bg-surface-container-lowest p-sm font-data-mono text-[12px] leading-5">
      {rows.map((row) => (
